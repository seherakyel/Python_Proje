kisi={"isim":"ali","yas":20,"cinsiyet":"men","hobiler":["konser","sinema","okuma"]}
print(kisi)
print(kisi["isim"])
print(kisi["hobiler"])
kisi["isim"]="ahmet" # isim anahtarını değerini değiştirdi aliyken ahmet oldu
print(kisi)
...
print(kisi.get("soyad")) # soyad anahtarı bulunmadğı için değeri yazmaz ama hata da vermez
